...
public class QLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FUNC", "INT", "MAIN", "FLOAT", "BOOL", "STRING", "VOID", "ASSIGN", "RETURN", 
			"IF", "ELSE", "WHILE", "GT", "LT", "GE", "LE", "NE", "AND", "OR", "EQ", 
			"PLUS", "MINUS", "STAR", "SLASH", "MOD", "BANG", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "LBRACK", "RBRACK", "COMMA", "DOT", "SEMICOLON", 
			"D_QUOTE", "TRUE", "FALSE", "NUL", "ID", "Char", "Digit", "Integer", 
			"Float", "StringLiteral", "Whitespace", "Newline"
		};
	}
